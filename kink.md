...
module KINK
  ...
  rule kDefinition(_:KRequireList, MODS:Modules)
    => (koreDefinition([ .Patterns ], MODS:Modules)):Definition

  rule (kModule(MNAME:KModuleName, ATTRS:OptionalAttributes, KIMPORTS:KImportList, DECLS:Declarations)):KModule
    => (koreModule(MNAME:KModuleName, DECLS:Declarations, [ .Patterns ])):Module
